...
public class ObjectsSortingWordPairsLambda {
	...
	public static void main(String[] args) {
		...
		Collections.sort(wordPairList, (a, b) -> a.getEnglishWord().compareTo(b.getEnglishWord()));
		...
		Collections.sort(wordPairList, (a, b) -> a.getFinnishWord().compareTo(b.getFinnishWord()));
